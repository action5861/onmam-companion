      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4 text-white">온맘동행</h3>
            <p className="mb-4 text-gray-400">지방에 계신 어르신들의 서울/경기 지역 병원 방문을 위한 전문 동행 서비스</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="#services" className="hover:text-white">서비스 소개</Link>
              </li>
              <li>
                <Link href="#benefits" className="hover:text-white">서비스 혜택</Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-sm text-gray-500">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p>© 2025 온맘동행. All rights reserved.</p>
